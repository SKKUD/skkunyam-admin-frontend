...
const TopNoticeItem = ({ notice, onNoticeClick }) => {
    const handleClick = () => {
        onNoticeClick(notice);
    };

    return (
        <Box onClick={handleClick} sx={{display: 'flex', flexDirection: 'row', alignItems: 'center', bgcolor: 'rgba(238, 238, 238, 1)', p: '8px 20px', mt: '10px', gap: '15px', borderRadius: '4px'}}>
